    ...
    for (TimeTable t in rescheduleviewmodel.lsttimetable) {
      if (t.starttime.toString() == time) {
        if (t.day == "Mon") {
          ...
          Venue v = vtuelst.where((element) => element.id == t.vid).first;
          tuelst.remove(v.name);
        } else if (t.day == "Wed") {
          Venue v = vwedlst.where((element) => element.id == t.vid).first;
          wedlst.remove(v.name);
        } else if (t.day == "Thu") {
          Venue v = vthulst.where((element) => element.id == t.vid).first;
          thulst.remove(v.name);
        } else if (t.day == "Fri") {
          Venue v = vfrilst.where((element) => element.id == t.vid).first;
